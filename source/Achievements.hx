...
class Achievements { 
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		["Oink!",	"Finish the Week 1",						'piggy_noises',	 false],
		["Wan wan...",		"Complete 'Eppa'",				'omg_its_eppa',			false],
		["Something appeared...",				"Unlock the Week 2",				'w_what',			false],
		["Uh, Yeah! Haha",					"Beat any song with 0 misses",				'fc_any',			false],
		["Bad beat...",			"Lose the Week 1",				'loser_lol',			false],
		["Look at the creators!",					"Check the credits!",				'its_me',			false],
		["Vegetables and fruits!",		"Complete 'Im Mr Potato'",				'potato_beat',			 false],
		["I have everything! ",	"Complete all songs with 0 misses!",	'fc_all',				false]
	];
