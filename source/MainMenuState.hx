...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var bg:FlxSprite = new FlxSprite(-80).loadGraphic(Paths.image('VsgokuMenu'));
		...
		var a:FlxSprite = new FlxSprite(-200, 0).loadGraphic(Paths.image('aaa'));
		a.antialiasing = ClientPrefs.globalAntialiasing;
		a.flipY = true;
		add(a);
